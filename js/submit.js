...
function handlesubmitform(event){
    ...
    //grab fruit 1
    let fruit1 = document.getElementById("vegetable1").value
    document.getElementById("submittedVegetable1").innerHTML = vegetabledata[vegetable1].name
    //grab fruit 2
    let fruit2 = document.getElementById("vegetable2").value
    document.getElementById("submittedVegetable2").innerHTML = vegetabledata[vegetable2].name
    //grab fruit 3
    let fruit3 = document.getElementById("vegetable3").value
    document.getElementById("submittedVegetable3").innerHTML = vegetabledata[vegetable3].name
